    ...
    def _provision_instances(self, context, instance_type, min_count,
        ...
        try:
            for i in range(num_instances):
                ...
                if tags:
                    objects.TagList.create(context, instance_uuid, tags)
    ...
    def snapshot_volume_backed(self, context, instance, name,
        ...
        for bdm in bdms:
            ...
            if bdm.is_volume:
                ...
                # NOTE(wanghao): If instance is volume backend, we should set
                #                the min_disk in the image meta based on the
                #                root volume's size.
                if mapping_dict['boot_index'] == 0:
                    image_meta['min_disk'] = volume['size']
            else:
