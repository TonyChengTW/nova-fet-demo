...
class RequestSpec(base.NovaObject):
    ...
    fields = {
        ...
        'rs_aggregate_id': fields.IntegerField(default=0)
    }
    ...
    def from_primitives(cls, context, request_spec, filter_properties):
        ...
        spec.rs_aggregate_id = filter_properties.get('rs_aggregate_id', 0)
    ...
    def from_components(cls, context, instance_uuid, image, flavor,
        ...
        spec_obj.rs_aggregate_id = filter_properties.get('rs_aggregate_id', 0)
    ...
    def _from_db_object(context, spec, db_spec):
        ...
        for key in spec.fields:
            ...
            elif key in ['rs_aggregate_id']:
                setattr(spec, key, spec.fields[key].default)
            else:
